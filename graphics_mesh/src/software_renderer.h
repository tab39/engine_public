...
class SoftwareRendererImp : public SoftwareRenderer {
 ...
 private:
  ...
  void draw_steep_line(float x0, float y0, float x1, float y1, Color color);
  ...
  void rasterize_triangle( float x1, float y1,
                           float x2, float y2,
                           float x3, float y3,
                           Color color ); // changed parameters for easier debugging
